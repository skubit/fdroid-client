...
public class Constants {
    ...
    public static final String CATALOG_URI_TEST = "https://catalog.skubit.net/rest/catalog";

    public static final String LOCKER_URI_PROD = "https://catalog.skubit.com/rest/v1/locker";

    public static final String CATALOG_URI_PROD = "https://catalog.skubit.com/rest/catalog";
