 ...
 */
public class MarketSQLiteOpenHelperCallbacks {
    private static final String TAG = MarketSQLiteOpenHelperCallbacks.class.getSimpleName();
    ...
    public void onUpgrade(final Context context, final SQLiteDatabase db, final int oldVersion, final int newVersion) {
      ...
      //  new MarketSQLiteUpgradeHelper().onUpgrade(db, oldVersion, newVersion);
    }
}
