...
import com.skubit.market.provider.base.BaseContentProvider;
import com.skubit.market.provider.accounts.AccountsColumns;

import org.fdroid.fdroid.BuildConfig;

public class MarketProvider extends BaseContentProvider {
    ...
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return MarketSQLiteOpenHelper.getInstance(getContext());
    }
