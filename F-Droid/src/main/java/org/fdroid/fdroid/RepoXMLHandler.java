    ...
    public void endElement(String uri, String localName, String qName)
        ...
        if (curel.equals("application") && curapp != null) {
            ...
            case "web":
                ...
                break;
            case "tracker":
                //TODO: Hack: use uri to pass in some info we need to purchases
                if(!TextUtils.isEmpty(str)) {
                    try {
                        Uri tracker = Uri.parse(str);
                        String productId = tracker.getQueryParameter("productId");
                        String price = tracker.getQueryParameter("price");
                        if(!TextUtils.isEmpty(productId) && !TextUtils.isEmpty(price)) {
                            curapp.productId = productId;
                            curapp.satoshi = Long.parseLong(price);
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
