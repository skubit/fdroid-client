 ...
 */
public class AppListFragmentPagerAdapter extends FragmentStatePagerAdapter {

    private ActionBarActivity parent = null;

    public AppListFragmentPagerAdapter(ActionBarActivity parent) {
