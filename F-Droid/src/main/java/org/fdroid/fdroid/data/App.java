...
public class App extends ValueObject implements Comparable<App> {
    ...
    public App(Cursor cursor) {
        ...
        for (int i = 0; i < cursor.getColumnCount(); i++) {
            ...
            case AppProvider.DataColumns.InstalledApp.VERSION_NAME:
                ...
                break;
            case AppProvider.DataColumns.SATOSHI:
                satoshi = cursor.getLong(i);
                break;
            case AppProvider.DataColumns.PRODUCT_ID:
                productId = cursor.getString(i);
                break;
            }
        }
    }
    ...
    public ContentValues toContentValues() {
        ...
        values.put(AppProvider.DataColumns.ICON_URL, iconUrl);
        values.put(AppProvider.DataColumns.PRODUCT_ID, productId);
        values.put(AppProvider.DataColumns.SATOSHI, satoshi);
        return values;
    }
